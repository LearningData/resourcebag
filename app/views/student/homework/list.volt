        ...
        <tr>
            ...
            <td>
                ...
                {% if homework.isReviewed() %}
                    {{ link_to("homework/show/"~homework.id,
                        "class":"btn-icon btn-review", "Review")}}
                {% else %}
                    <span class="btn-icon btn-review">
                        {{ homework.getStatus()}}
                    </span>
                {% endif %}
                {{ link_to("student/homework/answer/"~homework.id,
                    "class":"btn-edit btn-icon", "Edit") }}
                {{ link_to("student/homework/submit/"~homework.id,
                    "class":"btn-submit btn-icon", "Submit") }}
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2" align="right">
                <table align="center">
                    <tr>
                        ...
                        <td>
                            {{ link_to("student/homework?page="~page.before~"&filter="~status, "Previous") }}
                        </td>

...
*/
    ...
    populateMessages = function( date ) {
        ...
        //$.get(url, function(response) {
        var response = {messages: [{status: 0, sender: "ST", text: "A reminder that non-uniform day is Friday 31st and all students not in uniform bring 1 Euro."},{status: 1, sender: "S", text: "Copies of the Physic's exam practice booklet are now available. Please collect from the Science office."},{status: 1, sender: "ST", text: "Attention all students who take Bus 4: the route will no longer include Ferryhill Tesco's stop."},{status: 1, sender: "S", text: "Student's needing to purchase PE kit, the new Football shirt is available. See the PE department."}, 
{status: 0, sender: "ST", text: "House Captain's meeting is a lunctime on Wednesday. Please be there! Room 24."}, {status: 0, sender: "ST", text: "Form tutor interview's for Target setting happen week beginning November 4th. You must check the list in your form room for your time. Target setting is important."}, {status: 1, sender: "P", text: "House Captain's meeting is a lunctime on Wednesday. Please be there! Room 24."}, {status: 1, sender: "S", text: "Student's needing to purchase PE kit, the new Football shirt is available. See the PE department."}, {status: 1, sender: "ST", text: "A reminder that non-uniform day is Friday 31st and all students not in uniform bring 1 Euro."}, {status: 1, sender: "S", text: "Copies of the Physic's exam practice booklet are now available. Please collect from the Science office."}, {status: 0, sender: "ST", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In risus ipsum."}, {status: 0, sender: "ST", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In risus ipsum."}, {status: 1, sender: "P", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In risus ipsum."}, {status: 1, sender: "S", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In risus ipsum."},
...
{status: 0, sender: "ST", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In risus ipsum."},{status: 1, sender: "S", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In risus ipsum."},
{status: 1, sender: "ST", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In risus ipsum."},{status: 1, sender: "S", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In risus ipsum."}, 
